...
class Aboutcompany extends Component {
    ...
    render() {
        ...
        return (
            <div ref={this.sectionRef} className={`subheader mt-lg-0 mb-5 pt-5   fade-in-section ${isVisible ? 'visible' : ''}`} style={{ backgroundImage: "url(" + process.env.PUBLIC_URL + "/assets/img/bg/tenali-souble-horse-about-section-1900x600.webp)", paddingTop:'30px!important' }}>
