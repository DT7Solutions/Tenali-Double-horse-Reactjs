        ...
        <section id="gallery" class="gap-section">
          ...
          <div class="container">
            ...
            <img src={process.env.PUBLIC_URL + "/assets/img/home/new-idly-ravva.png"} style={{width:'500px'}} alt="" className='pt-5 ' />
              <div class="card-body">
                ...
                <a href={"https://dt7solutions.github.io/Tenali-Double-horse-Reactjs/#/Tenali-Double-horse-Reactjs/menu-item-v1/9"} target='_blank' className="btn-custom btn-sm">Read more</a>
          ...
          <img src={process.env.PUBLIC_URL + "/assets/img/home/urad-gota.png"} style={{width:'500px'}} alt="" className='pt-5 ' />
              <div class="card-body">
               ...
               <a href={"https://dt7solutions.github.io/Tenali-Double-horse-Reactjs/#/Tenali-Double-horse-Reactjs/menu-item-v1/1"} target='_blank' className="btn-custom btn-sm">Read more</a>
          ...
          <img src={process.env.PUBLIC_URL + "/assets/img/home/toordall.png"}  style={{width:'500px'}} alt="" className='pt-5 ' />
              <div class="card-body">
                ...
                <a href={"https://dt7solutions.github.io/Tenali-Double-horse-Reactjs/#/Tenali-Double-horse-Reactjs/menu-item-v1/6"}  target='_blank' className="btn-custom btn-sm " >Read more</a>
            ...
            <img src={process.env.PUBLIC_URL + "/assets/img/home/moong-dall.png"}  style={{width:'500px'}} alt="" className='pt-5 ' />
              <div class="card-body">
                ...
                <a href={"https://dt7solutions.github.io/Tenali-Double-horse-Reactjs/#/Tenali-Double-horse-Reactjs/menu-item-v1/7"} target='_blank'  className="btn-custom btn-sm " >Read more</a>
